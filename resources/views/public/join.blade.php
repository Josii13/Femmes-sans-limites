...
@section('description', 'Intègre la communauté Femmes Sans Limites et accède à des événements, formations et un réseau de femmes leaders d\'Afrique et de la diaspora.')
    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-8">
        <div class="max-w-3xl fade-up">
            ...
            <p class="text-xl leading-relaxed mb-10" style="color:var(--gray);max-width:560px;">
                Plus de 500 femmes d'Afrique et de la diaspora se soutiennent, s'élèvent et construisent ensemble au sein de Femmes Sans Limites.
            </p>
