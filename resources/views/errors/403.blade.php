...
<head>
    ...
    <title>Accès refusé — Femmes Sans Limites</title>
...
<div class="text-center max-w-lg mx-auto">
    ...
    <div class="flex items-center justify-center mb-6">
        <div class="relative">
            <p class="text-[120px] leading-none font-black select-none" style="color:var(--rose);opacity:.12;">403</p>
    ...
    {{-- Message --}}
    <h1 class="text-2xl font-black mb-3" style="color:var(--dark);">Accès refusé</h1>
    ...
    <div class="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a href="javascript:history.back()" class="btn-outline inline-flex items-center gap-2 justify-center">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
