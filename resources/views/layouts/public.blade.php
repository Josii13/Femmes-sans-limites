...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Femme Sans Limites est une communauté de transformation qui accompagne les femmes afin de les aider à dépasser leurs limites intérieures et devenir la meilleure version d'elles-mêmes",
      "sameAs": []
    }
    </script>
    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-8 pt-16 pb-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
            ...
            <div class="sm:col-span-2 lg:col-span-1">
                ...
                <div class="flex items-center gap-3">
                    {{-- Facebook --}}
                    <a href="https://www.facebook.com/profile.php?id=61577367732147" target="_blank" rel="noopener" class="w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200" style="background:rgba(255,255,255,0.08);" onmouseover="this.style.background='var(--rose)'" onmouseout="this.style.background='rgba(255,255,255,0.08)'" aria-label="Facebook">
                    ...
                    {{-- Instagram --}}
                    <a href="https://www.instagram.com/femme_sanslimite?utm_source=qr&igsh=MWJ4ZmdqemlqcHRjeg%3D%3D" target="_blank" rel="noopener" class="w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200" style="background:rgba(255,255,255,0.08);" onmouseover="this.style.background='var(--rose)'" onmouseout="this.style.background='rgba(255,255,255,0.08)'" aria-label="Instagram">
                    ...
                    {{-- TikTok --}}
                    <a href="https://www.tiktok.com/@f.limites?_r=1&_t=ZS-977znWEsLqu" target="_blank" rel="noopener" class="w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200" style="background:rgba(255,255,255,0.08);" onmouseover="this.style.background='var(--rose)'" onmouseout="this.style.background='rgba(255,255,255,0.08)'" aria-label="TikTok">
                    ...
                    {{-- WhatsApp --}}
                    <a href="https://wa.me/2250554437121" target="_blank" rel="noopener" class="w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200" style="background:rgba(255,255,255,0.08);" onmouseover="this.style.background='#25D366'" onmouseout="this.style.background='rgba(255,255,255,0.08)'" aria-label="WhatsApp">
